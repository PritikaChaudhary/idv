...
# Rails.logger.info "here333---#{Settings.settings}"
Rails.logger.info "here2--#{Settings}"
  ...
  #  bucket = S3.create_bucket(bucket: 'testbusketxyz')
   loan_url = LoanUrl.find_by_url(params[:id])
    ...
    if @loan.blank? && !current_user.blank?
      ...
      #@loan.info['Birthday'] = "14/05/1959"
      #@loan.info['_ExpectedCloseDate'] = "01/09/2015"
      #@loan.info['_OriginalPurchaseDateifitsarefinance'] = "26/10/1994"
      #@loan.info['_AppraisalDate'] = "05/06/2014"
      #@loan.info['_DateofValuation'] = "01/08/2015"
      #@loan.save
      #abort("#{@loan.inspect}")
    end
    if @loan.blank?
